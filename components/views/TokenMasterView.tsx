...
import { RefreshCwIcon, CheckCircleIcon, XIcon, DatabaseIcon, UsersIcon, TrashIcon, PlayIcon } from '../Icons';
        ...
        if (tokensJSON) {
            try {
                ...
                if (Array.isArray(parsed)) {
                    ...
                    const initialResults: Record<string, Record<string, MatrixCell>> = {};
                    formatted.forEach((t: TokenData) => {
                        initialResults[t.token] = {};
                        UI_SERVER_LIST.forEach(s => {
                            initialResults[t.token][s.id] = { status: 'idle', imagen: null, veo: null };
                        });
                    });
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-800 flex flex-col flex-1 overflow-hidden">
                ...
                <div className="p-4 border-b border-neutral-200 dark:border-neutral-800 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            onClick={loadTokens}
                            className="px-3 py-2 bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 rounded-lg text-xs font-bold"
